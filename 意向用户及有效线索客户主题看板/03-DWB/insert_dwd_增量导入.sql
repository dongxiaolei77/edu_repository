    ...
    where id not in
          (select customer_relationship_first_id
           ...
           where appeal_status = 1
             ...
             and dwd_customer_appeal_fact.start_date >= date_add(current_date, -30))
    union all
...
where dcrf.end_date = '9999-12-30'
  and dcrf.start_date = date_add(current_date, -1)
  and dccf.end_date = '9999-12-30'
  and dccf.start_date = date_add(current_date, -1)
  and dcf.end_date = '9999-12-30'
  and dcf.start_date = date_add(current_date, -1);
