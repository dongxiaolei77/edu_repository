...
;
alter table edu_ods.ods_customer_relationship
    set tblproperties ('comment' = '客户意向表');
...
alter table edu_ods.ods_customer
    set tblproperties ('comment' = '客户静态信息表');
...
alter table edu_ods.ods_customer_clue
    set tblproperties ('comment' = '客户线索表');
-- customer_appeal申诉表 (事实表)
create table ods_customer_appeal
(
    id                             int,
...
alter table ods_customer_appeal
    set tblproperties ('comment' = '线索申诉表');
...
alter table edu_ods.ods_itcast_subject
    set tblproperties ('comment' = '学科表');
-- itcast_school 校区表 (维度表)
create table ods_itcast_school
(
    id               int,
    create_date_time string comment '创建时间',
    update_date_time string comment '最后更新时间',
...
alter table ods_itcast_school
    set tblproperties ('comment' = '学校表');
-- employee（员工表）(维度表)
...
alter table ods_employee
    set tblproperties ('comment' = '员工信息表');
-- scrm_department（部门表）(维度表)
create table ods_scrm_department
(
    id               int,
...
alter table ods_scrm_department
    set tblproperties ('comment' = '部门表');
